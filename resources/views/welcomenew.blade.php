...
<html lang="en">
    <head>
        ...
        <link href="https://startbootstrap.github.io/startbootstrap-coming-soon/css/styles.css" rel="stylesheet" />
    </head>
    <body>
        <!-- Background Video-->
                ...
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                        ...
                        <div class="row input-group-newsletter">
                            <div class="col"></div>
                           <a href="/hosts"> <div class="col-auto"><button class="btn btn-primary disabled" id="submitButton" type="submit">Assesment</button></div></a>
        ...
        <!-- Core theme JS-->
        <script src="https://startbootstrap.github.io/startbootstrap-coming-soon/js/scripts.js"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
